...
export const FlightListScreen = ({ onBack, onSelectFlight, language, appearance }: FlightListScreenProps) => {
        ...
        <div className="fixed inset-0 z-[100] flex items-end justify-center bg-black/60 backdrop-blur-sm">
          ...
          >
            <div className="flex justify-between items-center mb-8">
              <h3 className={`text-xl font-bold ${appearance === 'Dark Mode' ? 'text-white' : 'text-slate-900'}`}>Filter Flights</h3>
            ...
            <div className="space-y-8">
              {/* Stops */}
              <div>
                <p className={`text-sm font-bold mb-4 ${appearance === 'Dark Mode' ? 'text-white' : 'text-slate-900'}`}>Stops</p>
              ...
              <div>
                <div className="flex justify-between items-center mb-4">
                  <p className={`text-sm font-bold ${appearance === 'Dark Mode' ? 'text-white' : 'text-slate-900'}`}>Price Range</p>
              ...
              <div>
                <div className="flex justify-between items-center mb-4">
                  <p className={`text-sm font-bold ${appearance === 'Dark Mode' ? 'text-white' : 'text-slate-900'}`}>Max Duration</p>
    ...
    <div className={`min-h-screen pb-24 pt-8 px-6 max-w-4xl mx-auto transition-colors duration-300 ${appearance === 'Dark Mode' ? 'bg-slate-950 text-white' : 'bg-white text-slate-900'}`}>
      ...
      <div className="flex items-center gap-2 mb-12">
        <div className={`flex-1 p-6 rounded-[32px] shadow-sm border relative transition-colors ${appearance === 'Dark Mode' ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-50'}`}>
          <p className="text-xs font-bold text-slate-400 mb-1">From</p>
        ...
        <div className={`flex-1 p-6 rounded-[32px] shadow-sm border text-right transition-colors ${appearance === 'Dark Mode' ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-50'}`}>
          <p className="text-xs font-bold text-slate-400 mb-1">To</p>
      ...
      <div className="flex justify-between items-center mb-6">
        <h2 className={`text-xl font-bold ${appearance === 'Dark Mode' ? 'text-white' : 'text-slate-900'}`}>Popular Flights</h2>
        <button 
            ...
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="flex-[1.5] px-2 flex flex-col items-center justify-center">
                <div className="flex flex-col items-center">
                  <p className="text-[10px] font-bold text-blue-500 mb-1">100% on time</p>
